    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Categoria Post: Lixeira
                            <small>Contém as categorias que você enviou para lixeira.</small>
                        </h2>
                    ...
                    <div class="x_content">
                        <div class="fixed-table-toolbar pull-right">
                            ...
                            <a href="{{ route('admin.post.cat.index') }}" class="btn btn-danger btn-sm"><i class="fa fa-mail-reply"></i> Voltar</a>
                        </div>
                        <div class="clear"></div>
