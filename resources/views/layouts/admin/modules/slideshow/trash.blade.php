                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="fixed-table-toolbar pull-right">
                            ...
                            <a href="{{ route('admin.slideshow.index') }}" class="btn btn-danger btn-sm"><i class="fa fa-mail-reply"></i> Voltar</a>
                        </div>
                        <div class="clear"></div>

                        @include('layouts.admin.modules.slideshow._table')
